...
const QUESTIONS = {
  general:[
    ...
    {id:"g3",type:"number",key:"weight", q:{en:"What is your weight? (lbs)",tl:"Ano ang iyong timbang? (lbs)",es:"¿Cuál es tu peso? (lbs)",ja:"体重（ポンド）",zh:"您的体重是多少？（磅）",fr:"Votre poids? (lbs)"},placeholder:{en:"e.g. 160",tl:"hal. 160",es:"ej. 160",ja:"例：160",zh:"例：160",fr:"ex. 160"}},
    ...
    {id:"g5",type:"choice",key:"sleep",  q:{en:"How many hours of sleep per night?",tl:"Ilang oras ka natutulog gabi-gabi?",es:"¿Cuántas horas duermes por noche?",ja:"一晩の睡眠時間は？",zh:"您每晚睡几个小时？",fr:"Combien d'heures dormez-vous par nuit?"},
      options:{en:["8+ hours","7–8 hours","6–7 hours","5–6 hours","Less than 5 hours"],tl:["8+ oras","7–8 oras","6–7 oras","5–6 oras","Wala pang 5 oras"],es:["8+ horas","7–8 horas","6–7 horas","5–6 horas","Menos de 5 horas"],ja:["8時間以上","7〜8時間","6〜7時間","5〜6時間","5時間未満"],zh:["8小时以上","7-8小时","6-7小时","5-6小时","不到5小时"],fr:["8+ heures","7–8 heures","6–7 heures","5–6 heures","Moins de 5 heures"]},risk:[0,0,1,1,2]},
    {id:"g6",type:"choice",key:"sleepqual",q:{en:"How would you rate the quality of your sleep?",tl:"Paano mo ilalarawan ang kalidad ng iyong tulog?",es:"¿Cómo calificarías la calidad de tu sueño?",ja:"睡眠の質は？",zh:"您如何评价睡眠质量？",fr:"Comment évalueriez-vous la qualité de votre sommeil?"},options:EXCEL5,risk:[0,0,1,2,2]},
  ...
  mental:[
    ...
    {id:"m11",type:"choice",key:"sleepmental",q:{en:"Does worry or stress regularly prevent you from sleeping?",tl:"Ang pag-aalala ba ay regular na pumipigil sa iyong pagtulog?",es:"¿La preocupación o el estrés te impide dormir regularmente?",ja:"心配やストレスで眠れないことがありますか？",zh:"担忧或压力是否经常妨碍您睡眠？",fr:"L'inquiétude ou le stress vous empêche-t-il régulièrement de dormir?"},options:NEVER5,risk:[0,0,1,2,2]},
  ],
  lifestyle:[
    ...
    {id:"l3",type:"choice",key:"diet",       q:{en:"How would you describe your overall diet?",tl:"Paano mo ilalarawan ang iyong pangkalahatang pagkain?",es:"¿Cómo describirías tu dieta en general?",ja:"全体的な食生活は？",zh:"您如何描述您的整体饮食？",fr:"Comment décririez-vous votre alimentation en général?"},
      options:{en:["Very healthy — balanced & nutritious","Mostly healthy","Mixed","Mostly unhealthy","Poor — mostly processed/fast food"],tl:["Napakagaling","Karaniwang malusog","Halo-halo","Karaniwang hindi malusog","Masama"],es:["Muy saludable","Mayormente saludable","Mixta","Mayormente poco saludable","Deficiente"],ja:["非常に健康的","ほぼ健康的","まちまち","あまり健康的でない","良くない"],zh:["非常健康——营养均衡","大多健康","混合","大多不健康","差——主要是加工食品"],fr:["Très saine","Plutôt saine","Mixte","Plutôt malsaine","Mauvaise — surtout fast food"]},risk:[0,0,1,1,2]},
    {id:"l4",type:"choice",key:"water",      q:{en:"How much water do you drink daily?",tl:"Gaano karaming tubig ang iyong iniinom araw-araw?",es:"¿Cuánta agua bebes diariamente?",ja:"1日にどのくらい水を飲みますか？",zh:"您每天喝多少水？",fr:"Quelle quantité d'eau buvez-vous quotidiennement?"},
